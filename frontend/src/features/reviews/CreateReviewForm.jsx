            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                    ...
                    <Rating
                        ...
                        fullSymbol={<Star size={28} className="text-yellow-500" fill="currentColor" />}
                ...
                <button type="submit" disabled={loading} className="bg-[#FF385C] text-white font-bold py-2 px-6 rounded-lg hover:bg-red-600 transition disabled:bg-red-300">
