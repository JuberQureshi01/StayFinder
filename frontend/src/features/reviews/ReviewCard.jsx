...
const ReviewCard = ({ review, propertyId }) => {
    ...
    // The delete button is for real logged in user
    ...
    return (
        <div className="py-4 relative">
            <div className="flex items-center mb-2">
                <img
                    src={review.guest.profile?.profilePictureUrl || `https://ui-avatars.com/api/?name=${review.guest.profile.fullName}&background=random`}
            ...
            {canDelete && (
                <button onClick={handleDelete} className="absolute cursor-pointer hover:scale-150 hover:rotate-z-12 top-4 right-0 text-gray-400 hover:text-red-500 transition-colors">
                    <Trash2 size={16} />
                </button>
            )}
        </div>
